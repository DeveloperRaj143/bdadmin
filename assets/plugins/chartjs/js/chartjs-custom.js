$(function() {
    ...
    var myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ['21', '', '23', '', '25', '', '27', '29'],
            datasets: [{
                label: 'Google',
                data: [10, 20, 35, 10, 27, 11, 20,15],
                backgroundColor: [
                    gradientStroke1
                ],
                lineTension: 0.4,
